...
//Project:	Tresto Admin - Responsive Admin Template
//Primary use:	Tresto Admin - Responsive Admin Template
...
+(function ($) {
  ...
  (function ($) {
    ...
    $('#chat-circle, #chat-box-toggle, #chat-popup, #live-chat').click(
      function () {
