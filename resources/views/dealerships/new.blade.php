    ...
    <div class="row">
        <div class="col-lg-8 col-12 mx-auto">
            <div class="box">
                ...
                <form class="form" method="POST" action="{{ route('newDealershipEntry') }}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="name" type="text" value="{{ old('name') }}" required class="form-control  @error('name') is-invalid @enderror">
                                    @error('name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="tax_number" id="tax_number" type="text" value="{{ old('tax_number') }}" required class="form-control  @error('tax_number') is-invalid @enderror">
                                    @error('tax_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="password" id="password" type="text" value="{{ old('password') }}" required class="form-control  @error('password') is-invalid @enderror">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
